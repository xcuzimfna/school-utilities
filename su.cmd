...
nircmd.exe qboxtop "This tool is for educational purpose only, usage of School Utilities for attacking targets without prior mutual consent is illegal. Developers assume no liability and are not responsible for any misuse or damage cause by this program. do you want to continue?" "School Utilities" ddos.bat
goto main
...
:kahoot_flooder
cls
title Kahoot Flooder (deprecated) - School Utilities
...
tasklist
echo.
echo Please insert a valid process - type 'exit' for main menu
set /p process=
If /i "%process%" == "exit" (goto main)
goto processkilln


:4
cd %~dp0/files
start /min powershell -command "&{start-process bs.bat -verb RunAs}"
echo. please wait...
cls
goto main
exit
